...
1. Go to the repository's **Security** tab → **Report a vulnerability**
   (https://github.com/DiamondsLab/diamonds-monitor/security/advisories/new).
...
<https://github.com/DiamondsLab/diamonds-monitor/issues> asking a maintainer to open a private channel —
